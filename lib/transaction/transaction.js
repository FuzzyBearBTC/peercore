...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  writer.writeUInt32LE(this.creation_time);
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  this.creation_time = reader.readUInt32LE();
...
Transaction.prototype.setTransactionDate = function(time) {
  $.checkArgument(time);
...
Transaction.prototype.getTransactionTime = function() {
  if (!this.creation_time) {
    return null;
  }

  return new Date(1000 * this.creation_time);
};
...
Transaction.prototype._newTransaction = function() {
  ...
  this.creation_time = (new Date().getTime() / 1000);
};
